...
const BioDatabase = {
  ...
  buildings: [
    ...
    {
      id: "BLD_VESSEL_STRAIGHT_X",
      name: "Сосуд (горизонт. X)",
      icon: "━",
      tier: "t0",
      ...
      atp_capacity: 40,
      atp_production_per_minute: 0,
      vessel_type: "straight_x",
      immersion: 0.5
    },
    {
      id: "BLD_VESSEL_STRAIGHT_Z",
      name: "Сосуд (вертик. Z)",
      icon: "┃",
      tier: "t0",
      tags: ["VESSEL", "SYSTEM_STRUCTURE"],
      ...
      atp_capacity: 40,
      atp_production_per_minute: 0,
      vessel_type: "straight_z",
      immersion: 0.5
    },
    {
      id: "BLD_VESSEL_ELBOW",
      name: "Сосуд (локоть 90°)",
      icon: "└",
      tier: "t0",
      tags: ["VESSEL", "SYSTEM_STRUCTURE"],
      size: [1, 1],
    ...
    },
    {
      ...
      hp: 60,
      throughput: 1.0,
      atp_consumption_per_minute: 1.5,
      atp_capacity: 40,
      atp_production_per_minute: 0,
      vessel_type: "tee",
      immersion: 0.5
    ...
    },
    {
      ...
      hp: 30,
      throughput: 0.5,
      atp_consumption_per_minute: 0.5,
      atp_capacity: 20,
      atp_production_per_minute: 0,
      vessel_type: "endcap",
      immersion: 0.5
    ...
    {
      id: "BLD_VESSEL_EMPTY_CONNECTOR",
      name: "Разъём (без входов)",
      icon: "◇",
      tier: "t0",
      tags: ["VESSEL", "SYSTEM_STRUCTURE"],
      size: [1, 1],
      hp: 40,
      throughput: 0,
      atp_consumption_per_minute: 0,
      atp_capacity: 30,
      atp_production_per_minute: 0,
      vessel_type: "empty_connector",
      immersion: 0.5,
      description: "Разъём для смены направления потока без производства/потребления"
    },
    {
